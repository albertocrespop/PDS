...
public class PersistenciaTest {
    ...
    public void testPersistenciaCompleta() {
        ...
        preguntas.add(new PreguntaRellenarPalabras("Completa: Una clase hija ___", "hereda", "Una clase hija _____ de la clase padre"));
        ...
        assertEquals(4, l.getPreguntas().size());
    }
}
